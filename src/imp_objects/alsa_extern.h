...
#ifndef IMP_OBJECT_ALSA_EXTERN_INCLUDE
#define IMP_OBJECT_ALSA_EXTERN_INCLUDE

#include <alsa/asoundlib.h>


typedef struct alsa_extern alsa_extern_t;
struct alsa_extern{

  int owner_object_address;
  int device_channel;
  void* device_buffer; /*usually different data type from internal buffers*/

  //ll_head attachment_list; /*used by extern_out to track attachements*/
};
